...
!function (a) {
    ...
    FlipClock.Face = FlipClock.Base.extend({
        ...
        createDivider: function (b, c, d) {
            ...
            var f = ['<span class="' + this.factory.classes.divider + " " + (c ? c : "").toLowerCase() + '">', '<span class="' + this.factory.classes.label + '">' + (b ? b : "") + "</span>", e, "</span>"], g = a(f.join(""));
...
}(jQuery), function (a) {//qwewqewqewqewqewqewq
    FlipClock.HourlyCounterFace = FlipClock.Face.extend({
        constructor: function (a, b) {
            ...
            c = c ? c : this.factory.time.getHourCounter(), c.length > e.length && a.each(c, function (a, b) {
                d.createList(b)
            }), a(this.createDivider("Seconds")).insertBefore(this.lists[this.lists.length - 2].$el), this.base()
        }, flip: function (a, b) {
