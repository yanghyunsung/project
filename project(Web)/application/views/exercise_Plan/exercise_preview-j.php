        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="/main_j/exercise_Go" style="font-family: HANYG0230">運動開始</a></li>
                </ul>
...
if ('exercise_Plan/exercise_preview') {
    ...
    <div class="list-group" style="width: 15%;float: left;text-align: center;">
        <span class="fa fa-calendar list-group-item" style="width: 100%" aria-hidden="true"><a href="#"> 日付選択</a></span>
...
<div class="preview_body">
    <h1  style="font-family: HANYG0230">運動計画が完了しました!</h1>
    ...
    for($i=0; $i < count($user_complete_info); $i++){
        foreach ($user_complete_info[$i] as $row) {
            ...
            echo "<tr style='font-family: HANYG0230;text-align: center;background-color: #1e87c3;color: white'><td>日付</td><td>ルーチン名</td><td>運動の名前</td><td>運動説明</td><td>回数</td><td>セット</td></tr>";
    ...
    ?>
    <a class="btn btn-primary raised" href="/main_j/exercise_Main" role="button" style="font-family: HANYG0230">完了</a>
</div>
<br>
<br>
</body>
