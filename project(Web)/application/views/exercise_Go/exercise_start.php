...
<head>
    ...
    <script src="/public/jquery-2.2.0/socket.io.js"></script>
...
<div class="container-fluid">
    <div class="row" style="margin: auto; margin-bottom: 10px; background-color:#3498db;">
        ...
        <div class="col-md-3">
            <div class="row" style="margin: auto">
                <div
                    style="font-family: HANYG0230;padding: 1px;margin-top: 25px;height: 85px;text-align: center;"
                    id="information"></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="row" style="margin: auto; position: relative">
                ...
                <span style="font-size: 25px; font-family: HANYG0230; margin-top: 15px;color: white;height: 85px; position: absolute; top: 20px; left: 35px">세트수:</span><div style="float: right" id="information_set"></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="row" style="margin: auto; position: relative">
                ...
                <span style="font-size: 25px; font-family: HANYG0230; margin-top: 15px;color: white;height: 85px; position: absolute; top: 20px; left: 10px">운동횟수:</span><div style="float: right" id="information_count"></div>
            </div>
        </div>
    </div>
    <div class="row" style="margin: auto">
            ...
            <div class="row" style="margin: auto">
                <div class="panel panel-success">
                    <div class="panel-body"
                         style="font-family: HANYG0230; padding: 0; height: 611px;">
                        <div class="row" style="padding:0; margin: 0;">
                            <div class="col-md-6">
                                <h3 style="margin: 0; margin-top: 20px;">좌측 삼각근</h3>
                            </div>
                            <div class="col-md-6">
                                <h3 style="margin: 0; margin-top: 20px">우측 삼각근</h3>
                            </div>
                        </div>
    ...
    <div class="row" id="progress" style="padding-bottom : 5px; padding-right : 20px; margin: auto">
        <p style="margin-left : 10px; font-size : 30px; font-family: HANYG0230; text-align: left;">진행률(<span id="percent">0%</span>)</p>
...
<script>
    ...
    function UnityReady(temp) {
        ...
        u.getUnity().SendMessage("CoordinateMapper", "setLang", "kr");
    }
    $(document).ready(function () {
        ...
        //var socket = io('http://jycom.asuscomm.com:5080/5300');
        ...
        socket.on('toTest', function(data){
            if(UnityLoaded){
                ...
                console.log("data");
                vprogress.value = makeRandom(50,makeRandom(50, 99));
                vprogress.grow();

                vprogress2.value = makeRandom(50,makeRandom(50, 99));
                vprogress2.grow();
            }
