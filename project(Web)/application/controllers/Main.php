...
//        $order = $_REQUEST['order'];
    ...
    public function exercise_Result()
    {
        ...
        $this->Exercise->save_calorie_info($today, $exercise_time);

        $data['calorie_info'] = $this->Exercise->get_calorie_info();

        $data['achievement_count'] = $this->Exercise->exercise_Result();
        $data['total_achievement_count'] = $this->Exercise->exercise_Result2();
